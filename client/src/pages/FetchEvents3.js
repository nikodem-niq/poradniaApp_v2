...
const FetchEvents3 = props => {
    ...
    useEffect(() => {
        ...
        const endpoints = [
            ...
            '/fetchData/events-get-2023-2024'
        ]
  ...
  return (
        ...
        <div>
            ...
            <Form>
                    ...
                    <AddButton to="#" onClick={() => { editItem("/updateData/event-edit-2023-2024",{dateOfEvent, employees, institutionId, programId, forWho, classes, howManyParticipiants, howManyPrograms, differentNameProgram}, props.id, setModal)}} style={ {backgroundColor: '#0f81d9'}}>Edytuj</AddButton>
                    {/* {isFormValid() &&
        ...
        <OuterWrapper>
            ...
            <Form>
                    ...
                    <AddButton to="#" onClick={() => { postData("/postData/event-add-2023-2024",{dateOfEvent, employees, institutionId, programId, forWho, classes, howManyParticipiants, howManyPrograms, differentNameProgram}, null, setReload, setModal, true)}} style={ isFormValid() ? {backgroundColor: 'red', pointerEvents: 'none'} : {backgroundColor: 'green'}}>Dodaj</AddButton>
                    {isFormValid() &&
                        <p>Wprowadz wszystkie wymagane dane!</p>
                    }
                </Form>
...
const SelectedEvent = props => {
    return (
        <table id="selectedRowTable">
            ...
            <tr>
                <td><DataButton className="updateBtn" width="0.5rem" height="0.3rem" fontSize="0.8rem" to={`/edit/event2/${props.selectedRow.idEvent}`}>Edytuj</DataButton>
                    <DataButton className="removeBtn" style={{margin: '0rem 0.3rem'}} onClick={() => {removeItem(props.selectedRow.idEvent, 'event3')}} width="0.5rem" height="0.3rem" fontSize="0.8rem" to="#">Usuń</DataButton> 
</td>
